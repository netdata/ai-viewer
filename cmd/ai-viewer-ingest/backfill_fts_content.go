...
func runBackfillFTSContent(ctx context.Context, args []string, stdout, stderr *os.File) int {
	...
	if err != nil {
		logger.Error("fts-content-backfill: daemon lock unavailable",
