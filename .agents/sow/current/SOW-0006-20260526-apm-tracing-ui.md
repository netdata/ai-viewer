...
- **Remaining:** a11y pass (axe on the four routes + keyboard nav to the drawer); SSE span-append animation (Trace/Timeline 200ms fade); Playwright E2E (per-AC + perf assertions); external review (codex+glm+minimax) → SOW-0006 PR.
