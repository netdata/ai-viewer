...
- **Remaining:** Playwright E2E (per-AC: routes/drawer/SSE-fade + real-browser axe on the 4 routes + perf assertions — 200ms flame / 500ms topology / 300ms timeline-zoom); then external review (codex+glm+minimax) → SOW-0006 PR.
